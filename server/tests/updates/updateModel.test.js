...
describe("updateModel",function() {
    ...
    it("Should insert a new update", function (done) {
        updateModel.insert("fakeType","fakeRegion","fakeRealm","fakeName",config.priorities[0], function (error) {
            assert.isNull(error);
            done();
        });
    });
    it("Should throw an error on type param required", function (done) {
        updateModel.insert(null,"fakeRegion","fakeRealm","fakeName",config.priorities[0], function (error) {
    ...
    it("Should throw an error on region param required", function (done) {
        updateModel.insert("fakeType",null,"fakeRealm","fakeName",config.priorities[0], function (error) {
            assert.isNotNull(error);
    ...
    it("Should throw an error on realm param required", function (done) {
        updateModel.insert("fakeType","fakeRegion",null,"fakeName",config.priorities[0], function (error) {
            assert.isNotNull(error);
    ...
    it("Should throw an error on name param required", function (done) {
        updateModel.insert("fakeType","fakeRegion","fakeRealm",null,config.priorities[0], function (error) {
            assert.isNotNull(error);
    ...
    it("Should throw an error on priority param required", function (done) {
        updateModel.insert("fakeType","fakeRegion","fakeRealm","fakeName",null, function (error) {
            assert.isNotNull(error);
    ...
    it("Should throw an error on priority param not in config file", function (done) {
        updateModel.insert("fakeType","fakeRegion","fakeRealm","fakeName","fakePriority", function (error) {
            assert.isNotNull(error);
