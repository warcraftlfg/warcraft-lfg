(function () {
    ...
    function CharacterList($scope, $stateParams, $state, socket, wlfgAppTitle, characters) {
        ...
        $scope.$watch('filters', function () {
            ...
            if ($scope.filters.states.realmZones && $scope.filters.states.languages && $scope.filters.states.realm && $scope.filters.states.role && $scope.filters.states.classes && $scope.filters.states.ilevel) {
